...
# If you really want to use all of the objects from a module, use the standard import module_name
...
that are contained within a package. A package is simply a module that contains sub-modules.
